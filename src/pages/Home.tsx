...
function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#6163b8] via-[#3e4299] to-[#252870] text-white w-full">
      {/* Decorative blobs - Mobile safe */}
      <div className="absolute top-[-20%] right-[-10%] w-[300px] sm:w-[400px] lg:w-[600px] aspect-square bg-[#6163b8]/20 rounded-full blur-[80px] sm:blur-[120px] animate-float mix-blend-screen pointer-events-none" />
...
function PromotionsSection() {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-[#eeeef8] to-white w-full">
      <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-8 sm:mb-10 gap-4 w-full">
          <SectionTitle
            tag="Ưu đãi"
...
function BestSellers() {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-[#141636] text-white w-full">
      <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
...
function CategorySectionItem({ category }: { category: Category }) {
  ...
  return (
    <section className="py-12 sm:py-16 bg-[#f5f5fb] text-gray-900 w-full border-b border-[#d5d5f0] last:border-0">
      <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-8 sm:mb-10 gap-4 w-full">
