...
namespace Botble\ShipGhtk\Commands;
...
class InitShipghtkCommand extends Command
{
    use ConfirmableTrait;

    protected $signature = 'cms:shipghtk:init {--key= : The Test API Token to use} {--force : Force the operation to run when in production}';

    protected $description = 'ShipGhtk Initialization';
    ...
    public function handle()
    {
        ...
        $settings = [
            ...
            [
                'key' => 'shipping_shipghtk_test_key',
                'value' => $key,
            ],
            [
                'key' => 'shipping_shipghtk_status',
                'value' => $key ? '1' : '0',
            ],
        ];
        ...
        $this->info('ShipGhtk configuration initialized successfully!');
    }
