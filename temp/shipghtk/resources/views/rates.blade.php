{!! Form::open([
    ...
    <div class="payment-checkout-form mt-3">
        ...
        @else
            <div>
                <p>{{ trans('plugins/shipghtk::shipghtk.carrier_could_not_be_found') }}</p>
            </div>
        @endif
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="heading-new-rates">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-new-rates"
                        ...
                        {{ trans('plugins/shipghtk::shipghtk.view_other_exchange_rates', ['count' => count($rates)]) }}
                    </button>
                </h2>
    ...
    <button type="submit" class="btn btn-primary mt-2">{{ trans('plugins/shipghtk::shipghtk.update_rate') }}</button>
{!! Form::close() !!}
