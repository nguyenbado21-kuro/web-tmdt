...
namespace Botble\ShipViettelPost\Commands;
...
class InitShipViettelPostCommand extends Command
{
    use ConfirmableTrait;

    protected $signature = 'cms:shipviettelpost:init {--key= : The Test API Token to use} {--force : Force the operation to run when in production}';

    protected $description = 'ShipViettelPost Initialization';
    ...
    public function handle()
    {
        ...
        $settings = [
            ...
            [
                'key' => 'shipping_shipviettelpost_test_key',
                'value' => $key,
            ],
            [
                'key' => 'shipping_shipviettelpost_status',
                'value' => $key ? '1' : '0',
            ],
        ];
        ...
        $this->info('ShipViettelPost configuration initialized successfully!');
    }
